            ...
            >
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  {project.hasGithub && (
                    <motion.button
                      className="flex-1 bg-primary text-primary-foreground py-2 px-4 rounded-md text-sm font-medium hover:bg-primary/90 transition-colors flex items-center justify-center gap-2"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <Github className="w-4 h-4" />
                  ...
                  {project.hasDemo && (
                    <motion.button
                      className={`${project.hasGithub ? 'flex-1' : 'w-full'} border border-border py-2 px-4 rounded-md text-sm font-medium hover:bg-accent transition-colors flex items-center justify-center gap-2`}
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <ExternalLink className="w-4 h-4" />
                  ...
                  {!project.hasGithub && !project.hasDemo && (
                    <div className="w-full py-2 px-4 rounded-md text-sm text-muted-foreground text-center border border-dashed border-border">
                      Hardware/Personal Project
                    </div>
                  )}
                </div>
