...
export const experiences: Experience[] = [
  {
    ...
    technologies: ["Nextflow", "Python", "AWS", "Docker", "Git", "CI/CD", "SQL", "Bioinformatics"],
    isActive: true,
  ...
  },
  {
    ...
    technologies: ["Next.js", "FastAPI", "React", "Python", "Nextflow", "Slurm", "LDAP", "AWS S3", "HPC", "PostgreSQL"],
    isActive: false,
